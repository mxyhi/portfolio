...
export const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      href: "https://github.com/mxyhi/always-on-memory-agent",
      active: true,
      dates: "Mar 2026 - Present",
      description:
        "Deployable always-on memory service forked from Google's ADK example, with a unified aiohttp backend, persistent SQLite-based memory storage, and a shadcn/ui web console for auth, ingestion, and querying.",
      technologies: [
        "Python",
        "TypeScript",
        "Google ADK",
      ...
      image: "https://opengraph.githubassets.com/1/mxyhi/always-on-memory-agent",
      video: "",
    },
  ],
  hackathons: [
