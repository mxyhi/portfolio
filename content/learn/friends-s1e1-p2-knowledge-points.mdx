...
author: "Langhuam"
summary: "整理《老友记》第一季第 1 集 B 站 p=2 精讲课中的高频口语、真实语境、语法结构、发音现象、跟读练习和对应视频时间戳。"
---
...
> 时间戳：均为 B 站 p=2 这一集内的**大致视频时间范围**，基于抽帧与音频转写对齐。
...
<BilibiliVideo
  ...
  part={2}
  startTime={108}
  title="场景一：Rachel 冲进咖啡馆（01:48–08:18）"
/>
...
<BilibiliVideo
  ...
  part={2}
  startTime={498}
  title="场景二：介绍 Rachel 给大家认识（08:18–11:58）"
/>
...
<BilibiliVideo
  ...
  part={2}
  startTime={730}
  title="场景三：Rachel 给爸爸打电话（12:10–14:07；17:30–18:55）"
/>
...
<BilibiliVideo
  ...
  part={2}
  startTime={1500}
  title="场景四：安慰 Rachel 冷静下来（25:00–32:38）"
/>
...
<BilibiliVideo
  ...
  part={2}
  startTime={1961}
  title="场景五：Rachel 面试失败但买到打折靴子（32:41–34:39；38:08–39:00）"
/>
...
<BilibiliVideo
  ...
  part={2}
  startTime={2342}
  title="场景六：Rachel 的靴子、信用卡与独立生活（39:02–45:04）"
/>
...
<BilibiliVideo
  ...
  part={2}
  startTime={2704}
  title="场景七：剪信用卡，进入现实世界（45:04–50:23）"
/>
